...
/**
 * Provides the 'Contribution' block.
 *
 * @Block(
 *   id = "contribution_block",
 *   admin_label = @Translation("Contribution PAC")
 * )
 */
class ContributionBlock extends BlockBase {
  ...
  public function build() {
    $form_path = '\Drupal\am_net_donations\Form\ContributionForm';
    $info = [
    ...
    $contribution_form['#action'] = '/donations/pac-contribution';
    return [
