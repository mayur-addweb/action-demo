...
/**
 * Implements the main contribution form controller.
 *
...
class ContributionForm extends FormBase {
  ...
  public function getFormId() {
    return 'am_net_donations.landing.page.pac.donation';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $info = NULL) {
    ...
    $form['donations']['title'] = [
      '#type' => 'item',
      '#markup' => '<h3 class="accent-left purple">' . $this->t('Contribution') . '</h3>',
    ];
    // Contribution amount.
    $form['price_option'] = [
      '#type' => 'select',
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $event = new DonationEvent($account, $amount, $anonymous, $destination, $type, NULL, boolval($is_recurring), $recurring_interval);
