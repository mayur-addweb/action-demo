...
/**
 * Plugin implementation of the 'rss_media_thumbnail' formatter.
 *
 * @FieldFormatter(
 *   id = "rss_media_thumbnail",
 *   label = @Translation("RSS Thumbnail Url"),
 *   field_types = {
 *     "entity_reference"
 *   }
 * )
 */
class RSSMediaThumbnailFormatter extends ImageFormatter {
   ...
   *   The image style storage instance.
