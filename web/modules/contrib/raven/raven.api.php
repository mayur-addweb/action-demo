 ...
 *
 *   For example,
 *   $options['processorOptions']['Drupal\raven\Processor\SanitizeDataProcessor']['fields_re']
 *   can be used to pass a regular expression for fields, headers, cookies, etc.
 *   to be sanitized. Start with the default regular expression
 *   '/(SESS|pass|authorization|password|passwd|secret|password_confirmation|card_number|auth_pw)/i'
 *   and add any additional strings.
 *
 * @see \Drupal\raven\Logger\Raven::log()
 */
