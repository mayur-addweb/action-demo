 ...
 * @endcode
 */
$settings['hash_salt'] = 'FiKngYboBYMFxPfh84YKCkifHKSG3zq13_Fe9tfcePHHFyueizc4QtbgaURKxZhqM1X612OmKw';
 ...
 *
 * See http://cgit.drupalcode.org/redis/tree/README.md
 */
...
// START - COMMENT OUT THIS SECTION TO DISABLE REDIS CACHING
...
// END - COMMENT OUT THIS SECTION TO DISABLE REDIS CACHING
...
if (file_exists($releaseFile)) {
    $config['raven.settings']['release'] = trim(@file_get_contents($releaseFile));
}
