...
$config = array(
   ...
   */
  'technicalcontact_name' => 'utadmin',
  'technicalcontact_email' => 'developers@unleashed-technologies.com',
   ...
   */
  'auth.adminpassword' => 'KnYxsjnCS6Vifsrv',
   ...
   */
  'session.datastore.timeout' => 10 * (60 * 60), // 10 hours

  /*
   * Sets the duration, in seconds, auth state should be stored.
   */
  'session.state.timeout' => 10 * (60 * 60), // 10 hours
   ...
   * syntaxes.
   */
  'store.sql.dsn'                 => 'mysql:host=localhost;dbname=vscpacom',

  /*
   * The username and password to use when connecting to the database.
   */
  'store.sql.username' => 'vscpacom',
  'store.sql.password' => 'XUD14ZQ90r0a18g5',
...
$config['store.sql.dsn'] = 'mysql:host=vscpa-datastore0;dbname=vscpacom;port=3306';
$config['store.sql.username'] = 'vscpacom';
$config['store.sql.password'] = 'zb84259bXoYI0o9HclWFrCb';
$config['auth.adminpassword'] = 'KnYxsjnCS6Vifsrv';